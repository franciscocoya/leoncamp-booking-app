 ...
 * @returns
 */
export const translateBookingStatus = (status: string): number =>
  bookinStatus.indexOf(status);
 ...
 * @returns
 */
export const translateCategory = (category: string): number =>
 ...
 * @returns
 */
export const translateAmenity = (amenity: string): number =>
